...
- **`../db.rs`** — module root: `open_connection()`, `upsert_knot_hot()`, `list_knot_hot_paginated()`, `CURRENT_SCHEMA_VERSION`
...
- **`tests.rs`** / **`tests_ext.rs`** / **`tests_pagination.rs`** — query and migration tests
